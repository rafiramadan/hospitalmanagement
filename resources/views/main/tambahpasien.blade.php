                    ...
                    <div class="form-group">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="tgllahir" class="form-control"
                                placeholder="Tanggal Lahir (Tanggal-Bulan-Tahun)">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group mb-3">
                            ...
                            <select name="jeniskelamin" class="form-select"
                                ...
                                <option style="color:grey" disabled="disabled" selected="selected">Pilih Jenis Kelamin
                                </option>
                                <option value="L">Laki-Laki</option>
                                <option value="P">Perempuan</option>
                            </select>
                            <select name="goldar" class="form-select" style="background-color: rgb(230, 230, 230)">
                                <option style="color:grey" disabled="disabled" selected="selected">Pilih Golongan Darah
                                </option>
                        ...
                        <div class=" offset-md-4">
                            <div class="input-group mb-3">
                                ...
                                <select name="jenisbayar" class="form-select"
                                    style="background-color: rgb(230, 230, 230)">
                                    <option style="color:grey" disabled="disabled" selected="selected">Pilih Jenis Bayar
                                    </option>
